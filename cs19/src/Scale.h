...
private:
    ...
    int lockLedGreen = 12;       // green lock led on front panel
    int lockLedBlue = 14;        // blue lock led on front panel
    int scale_print_button = 32; // this pin generates an interrupt when activity is detected on serial port controlled by console print button
